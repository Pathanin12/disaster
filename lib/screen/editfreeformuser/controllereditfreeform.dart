...
class ContollerEditOthersList extends GetxController {
  ...
  // var listConvertImage = <ImageList>[].obs;
  // var listConvertImageLog = <ImageList>[].obs;
  // var listConvertFileLog = <ImageList>[].obs;
...
class Textfield {
  String? title;
  TextEditingController? listevent;
  int type = 3;
...
class MyDropdown {
  String? title;
  RxList<String>? listevent;
  String? selectValue;
  int type = 0;

  MyDropdown({this.title, this.listevent, this.type = 0,this.selectValue});

  MyDropdown.fromJson(Map<String, dynamic> json) {
    title = json['title'];
    listevent = json['listevent'];
    type = json['type'] ?? 0;
...
class ValueAndID{
  ...
  ValueAndID({this.id, this.value});

  ValueAndID.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    value = json['value'];
  }
