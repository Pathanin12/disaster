import 'package:disaster/api/report/freeformbyidapi.dart';
...
class ContollerDetailFreeFormVillager extends GetxController {
  var IndexChart = 0.obs;
  var mapController = MapController().obs;
  var pageName = 'ข้อมูลรายงานอื่นๆ'.obs;
  var dataEvent = EventAllFreeFormByIDModel().obs;
  ...
  Future<void> getEvent() async {
    ...
    dataEvent = EventAllFreeFormByIDModel().obs;
    dataEvent.value = await getEventFreeFormByIDApi(Id: eventID!);
