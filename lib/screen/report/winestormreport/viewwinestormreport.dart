...
class WineStormReport extends StatelessWidget {
  WineStormReport({super.key});

  @override
  Widget build(BuildContext context) {
    final ContollerWineStormReport contoller =
        Get.put(ContollerWineStormReport(), permanent: false);
    return ListView(
      children: [
        Container(
