...
import 'contollerfloodreport.dart';

class FloodReport extends StatelessWidget {
  FloodReport({super.key});

  @override
  Widget build(BuildContext context) {
    final ContollerFloodReport contoller =
        Get.put(ContollerFloodReport(), permanent: false);
