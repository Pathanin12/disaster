        ...
        Container(
            ...
            child: Obx(() => Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: (MediaQuery.of(context).size.width<1130)?MediaQuery.of(context).size.width:MediaQuery.of(context).size.width*0.82,
                      height:  (contoller.dataAdmin.value.userList!.length*80)+80,
                    ...
                    Column(
                      children: [
                        ...
                        Container(
                          width: 1300,
                          height: (contoller.dataAdmin.value.userList!.length*80)+50,
                          child: Column(
                            children: [
                              Container(
                                width: 1300,
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        child: DropdownButtonHideUnderline(
                                                          child: DropdownButton2<String>(
                                                            ...
                                                            autofocus: true,
                                                            isExpanded: true,
                                                            value: contoller.dropdownListAdmin[index],
                                                            items: contoller.listAdmin
                                                            ...
                                                            onChanged: (valueSelect)async{
                                                              await updateAdmin(
                                                                  ...
                                                                  index]
                                                                      .id!,
                                                                  role: contoller.listAdmin.indexOf(valueSelect)+1,
                                                                  status:contoller.dataAdmin.value.userList![index].isAccept! );
                                                              setState(() {
                                                                contoller.dropdownListAdmin[index]=
                                                                valueSelect!;
                                                                contoller.dataAdmin.value.userList![index].roleName=valueSelect;
                                                      ...
                                                      onChanged:
                                                        ...
                                                        await updateAdmin(
                                                            ...
                                                            index]
                                                                .id!,
                                                            status: value,
                                                            role: contoller.listAdmin.indexOf(contoller.dropdownListAdmin[index])+1
                                                        );
                                                        contoller
                                                            .dataAdmin
                                                            .value
